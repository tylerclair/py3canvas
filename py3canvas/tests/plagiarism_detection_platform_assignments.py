...
import requests
import secrets
from py3canvas.apis.plagiarism_detection_platform_assignments import PlagiarismDetectionPlatformAssignmentsAPI
...
class TestPlagiarismDetectionPlatformAssignmentsAPI(unittest.TestCase):
    ...
    def setUp(self):
        self.client = PlagiarismDetectionPlatformAssignmentsAPI(secrets.instance_address, secrets.access_token)
