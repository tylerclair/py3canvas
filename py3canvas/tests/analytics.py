...
class TestAnalyticsAPI(unittest.TestCase):
    ...
    def test_get_department_level_participation_data_terms(self):
        ...
        r = self.client.get_department_level_participation_data_terms(account_id, term_id)
    ...
    def test_get_department_level_statistics_broken_down_by_subaccount_terms(self):
        ...
        r = self.client.get_department_level_statistics_broken_down_by_subaccount_terms(account_id, term_id)
    ...
    def test_get_department_level_statistics_broken_down_by_subaccount_current(self):
        ...
        r = self.client.get_department_level_statistics_broken_down_by_subaccount_current(account_id)
    ...
    def test_get_department_level_statistics_broken_down_by_subaccount_completed(self):
        ...
        r = self.client.get_department_level_statistics_broken_down_by_subaccount_completed(account_id)
    ...
    def test_get_course_level_student_summary_data(self):
        ...
        r = self.client.get_course_level_student_summary_data(course_id, sort_column=None, student_id=None)
    ...
    def test_get_user_in_a_course_level_participation_data(self):
        ...
        r = self.client.get_user_in_a_course_level_participation_data(course_id, student_id)
    ...
    def test_get_user_in_a_course_level_assignment_data(self):
        ...
        r = self.client.get_user_in_a_course_level_assignment_data(course_id, student_id)
