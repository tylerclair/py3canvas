...
import requests
import secrets
from py3canvas.apis.quiz_reports import QuizReportsAPI
from py3canvas.apis.quiz_reports import Quizreport
...
class TestQuizReportsAPI(unittest.TestCase):
    ...
    def test_retrieve_all_quiz_reports(self):
        ...
        r = self.client.retrieve_all_quiz_reports(
            course_id, quiz_id, includes_all_versions=None
        )
    ...
    def test_abort_generation_of_report_or_remove_previously_generated_one(self):
        ...
        r = self.client.abort_generation_of_report_or_remove_previously_generated_one(
            course_id, id, quiz_id
        )
