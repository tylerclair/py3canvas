...
class Blueprintsubscription(BaseModel):
    """Blueprintsubscription Model.
    Associates a course with a blueprint"""

    def __init__(self, id=None, template_id=None, blueprint_course=None):
        """Init method for Blueprintsubscription class."""
        self._id = id
        self._template_id = template_id
