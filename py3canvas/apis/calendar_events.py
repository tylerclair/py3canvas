...
class CalendarEventsAPI(BaseCanvasAPI):
    ...
    def list_calendar_events(
        ...
        self.logger.debug(
            "GET /api/v1/calendar_events with query params: {params} and form data: {data}".format(
                params=params, data=data, **path
            )
        )
        return self.generic_request(
            "GET",
            "/api/v1/calendar_events".format(**path),
            data=data,
            params=params,
            all_pages=True,
        )
    ...
    def list_calendar_events_for_user(
        ...
        if submission_types is not None:
            params["submission_types"] = submission_types

        # OPTIONAL - exclude_submission_types
        """
        ...
        """
        if exclude_submission_types is not None:
            params["exclude_submission_types"] = exclude_submission_types
        ...
        self.logger.debug(
            "GET /api/v1/users/{user_id}/calendar_events with query params: {params} and form data: {data}".format(
                params=params, data=data, **path
            )
        )
        return self.generic_request(
            "GET",
            "/api/v1/users/{user_id}/calendar_events".format(**path),
            data=data,
            params=params,
            all_pages=True,
        )
    ...
    def create_calendar_event(
        ...
        calendar_event_child_event_data_X_context_code=None,
        calendar_event_child_event_data_X_end_at=None,
        calendar_event_child_event_data_X_start_at=None,
        calendar_event_description=None,
        calendar_event_duplicate_append_iterator=None,
        calendar_event_duplicate_count=None,
        calendar_event_duplicate_frequency=None,
        calendar_event_duplicate_interval=None,
        calendar_event_end_at=None,
        calendar_event_location_address=None,
        calendar_event_location_name=None,
        calendar_event_start_at=None,
        calendar_event_time_zone_edited=None,
        ...
        if calendar_event_start_at is not None:
            if issubclass(calendar_event_start_at.__class__, str):
                calendar_event_start_at = self._validate_iso8601_string(
                    calendar_event_start_at
                )
            elif issubclass(calendar_event_start_at.__class__, date) or issubclass(
                calendar_event_start_at.__class__, datetime
            ):
                calendar_event_start_at = calendar_event_start_at.strftime(
                    "%Y-%m-%dT%H:%M:%S+00:00"
                )
        ...
        if calendar_event_end_at is not None:
            if issubclass(calendar_event_end_at.__class__, str):
                calendar_event_end_at = self._validate_iso8601_string(
                    calendar_event_end_at
                )
            elif issubclass(calendar_event_end_at.__class__, date) or issubclass(
                calendar_event_end_at.__class__, datetime
            ):
                calendar_event_end_at = calendar_event_end_at.strftime(
                    "%Y-%m-%dT%H:%M:%S+00:00"
                )
        ...
        # OPTIONAL - calendar_event[all_day]
        """
            When true event is considered to span the whole day and times are ignored.
        """
        if calendar_event_all_day is not None:
            data["calendar_event[all_day]"] = calendar_event_all_day
        ...
        if calendar_event_child_event_data_X_start_at is not None:
            if issubclass(calendar_event_child_event_data_X_start_at.__class__, str):
                ...
                calendar_event_child_event_data_X_start_at.__class__, date
            ) or issubclass(
                calendar_event_child_event_data_X_start_at.__class__, datetime
            ):
                calendar_event_child_event_data_X_start_at = (
                    calendar_event_child_event_data_X_start_at.strftime(
                        "%Y-%m-%dT%H:%M:%S+00:00"
                    )
                )
            data[
        ...
        if calendar_event_child_event_data_X_end_at is not None:
            if issubclass(calendar_event_child_event_data_X_end_at.__class__, str):
                ...
                calendar_event_child_event_data_X_end_at.__class__, date
            ) or issubclass(
                calendar_event_child_event_data_X_end_at.__class__, datetime
            ):
                calendar_event_child_event_data_X_end_at = (
                    calendar_event_child_event_data_X_end_at.strftime(
                        "%Y-%m-%dT%H:%M:%S+00:00"
                    )
                )
            data[
        ...
        if calendar_event_duplicate_frequency is not None:
            self._validate_enum(
                calendar_event_duplicate_frequency, ["daily", "weekly", "monthly"]
            )
            data[
        ...
        self.logger.debug(
            "POST /api/v1/calendar_events with query params: {params} and form data: {data}".format(
                params=params, data=data, **path
            )
        )
        return self.generic_request(
    ...
    def get_single_calendar_event_or_assignment(self, id):
        ...
        self.logger.debug(
            "GET /api/v1/calendar_events/{id} with query params: {params} and form data: {data}".format(
                params=params, data=data, **path
            )
        )
        return self.generic_request(
            "GET",
            "/api/v1/calendar_events/{id}".format(**path),
            data=data,
            params=params,
            single_item=True,
        )
    ...
    def reserve_time_slot(
        self, id, cancel_existing=None, comments=None, participant_id=None
    ):
        """
        Reserve a time slot.
        ...
        self.logger.debug(
            "POST /api/v1/calendar_events/{id}/reservations with query params: {params} and form data: {data}".format(
                params=params, data=data, **path
            )
        )
        return self.generic_request(
            "POST",
            "/api/v1/calendar_events/{id}/reservations".format(**path),
            data=data,
            params=params,
            no_data=True,
        )

    def reserve_time_slot_participant_id(
        self, id, participant_id, cancel_existing=None, comments=None
    ):
        """
        Reserve a time slot.
        ...
        self.logger.debug(
            "POST /api/v1/calendar_events/{id}/reservations/{participant_id} with query params: {params} and form data: {data}".format(
                params=params, data=data, **path
            )
        )
        return self.generic_request(
            "POST",
            "/api/v1/calendar_events/{id}/reservations/{participant_id}".format(**path),
            data=data,
            params=params,
            no_data=True,
        )
    ...
    def update_calendar_event(
        ...
        calendar_event_child_event_data_X_end_at=None,
        calendar_event_child_event_data_X_start_at=None,
        calendar_event_context_code=None,
        calendar_event_description=None,
        calendar_event_end_at=None,
        calendar_event_location_address=None,
        calendar_event_location_name=None,
        ...
        self.logger.debug(
            "PUT /api/v1/calendar_events/{id} with query params: {params} and form data: {data}".format(
                params=params, data=data, **path
            )
        )
        return self.generic_request(
    ...
    def delete_calendar_event(self, id, cancel_reason=None):
        ...
        self.logger.debug(
            "DELETE /api/v1/calendar_events/{id} with query params: {params} and form data: {data}".format(
                params=params, data=data, **path
            )
        )
        return self.generic_request(
    ...
    def set_course_timetable(
        self,
        course_id,
        timetables_course_section_id=None,
        timetables_course_section_id_end_time=None,
        timetables_course_section_id_location_name=None,
        timetables_course_section_id_start_time=None,
        timetables_course_section_id_weekdays=None,
    ):
        """
        ...
        self.logger.debug(
            "POST /api/v1/courses/{course_id}/calendar_events/timetable with query params: {params} and form data: {data}".format(
                params=params, data=data, **path
            )
        )
        return self.generic_request(
            "POST",
            "/api/v1/courses/{course_id}/calendar_events/timetable".format(**path),
            data=data,
            params=params,
            no_data=True,
        )
    ...
    def get_course_timetable(self, course_id):
        ...
        self.logger.debug(
            "GET /api/v1/courses/{course_id}/calendar_events/timetable with query params: {params} and form data: {data}".format(
                params=params, data=data, **path
            )
        )
        return self.generic_request(
    ...
    def create_or_update_events_directly_for_course_timetable(
        self,
        course_id,
        ...
        # OPTIONAL - events[title]
        """
            Title for the meeting. If not present, will default to the associated course's name
        """
        if events_title is not None:
            data["events[title]"] = events_title

        self.logger.debug(
            "POST /api/v1/courses/{course_id}/calendar_events/timetable_events with query params: {params} and form data: {data}".format(
                params=params, data=data, **path
            )
        )
        return self.generic_request(
            "POST",
            "/api/v1/courses/{course_id}/calendar_events/timetable_events".format(
                **path
            ),
            data=data,
            params=params,
...
class Calendarevent(BaseModel):
    ...
    def context_code(self, value):
        ...
        self.logger.warn(
            "Setting values on context_code will NOT update the remote Canvas instance."
        )
    ...
    def effective_context_code(self, value):
        ...
        self.logger.warn(
            "Setting values on effective_context_code will NOT update the remote Canvas instance."
        )
    ...
    def all_context_codes(self, value):
        ...
        self.logger.warn(
            "Setting values on all_context_codes will NOT update the remote Canvas instance."
        )
    ...
    def parent_event_id(self, value):
        ...
        self.logger.warn(
            "Setting values on parent_event_id will NOT update the remote Canvas instance."
        )
    ...
    def child_events_count(self, value):
        ...
        self.logger.warn(
            "Setting values on child_events_count will NOT update the remote Canvas instance."
        )
    ...
    def child_events(self, value):
        ...
        self.logger.warn(
            "Setting values on child_events will NOT update the remote Canvas instance."
        )
    ...
    def appointment_group_id(self, value):
        ...
        self.logger.warn(
            "Setting values on appointment_group_id will NOT update the remote Canvas instance."
        )
    ...
    def appointment_group_url(self, value):
        ...
        self.logger.warn(
            "Setting values on appointment_group_url will NOT update the remote Canvas instance."
        )
    ...
    def own_reservation(self, value):
        ...
        self.logger.warn(
            "Setting values on own_reservation will NOT update the remote Canvas instance."
        )
    ...
    def reserve_url(self, value):
        ...
        self.logger.warn(
            "Setting values on reserve_url will NOT update the remote Canvas instance."
        )
    ...
    def reserved(self, value):
        ...
        self.logger.warn(
            "Setting values on reserved will NOT update the remote Canvas instance."
        )
    ...
    def available_slots(self, value):
        ...
        self.logger.warn(
            "Setting values on available_slots will NOT update the remote Canvas instance."
        )
    ...
    def important_dates(self):
        """Boolean indicating whether this has important dates. Only present if the Important Dates feature flag is enabled."""
        return self._important_dates

    @important_dates.setter
    def important_dates(self, value):
        """Setter for important_dates property."""
        self.logger.warn(
            "Setting values on important_dates will NOT update the remote Canvas instance."
        )
        self._important_dates = value
...
class Assignmentevent(BaseModel):
    ...
    def assignment_overrides(self, value):
        ...
        self.logger.warn(
            "Setting values on assignment_overrides will NOT update the remote Canvas instance."
        )
