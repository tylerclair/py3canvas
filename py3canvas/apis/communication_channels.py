...
class CommunicationChannelsAPI(BaseCanvasAPI):
    ...
    def list_user_communication_channels(self, user_id):
        ...
        self.logger.debug(
            "GET /api/v1/users/{user_id}/communication_channels with query params: {params} and form data: {data}".format(
                params=params, data=data, **path
            )
        )
        return self.generic_request(
            "GET",
            "/api/v1/users/{user_id}/communication_channels".format(**path),
            data=data,
            params=params,
            all_pages=True,
        )
    ...
    def create_communication_channel(
        ...
        user_id,
        communication_channel_token=None,
        ...
        self.logger.debug(
            "POST /api/v1/users/{user_id}/communication_channels with query params: {params} and form data: {data}".format(
                params=params, data=data, **path
            )
        )
        return self.generic_request(
    ...
    def delete_communication_channel_id(self, id, user_id):
        ...
        self.logger.debug(
            "DELETE /api/v1/users/{user_id}/communication_channels/{id} with query params: {params} and form data: {data}".format(
                params=params, data=data, **path
            )
        )
        return self.generic_request(
            "DELETE",
            "/api/v1/users/{user_id}/communication_channels/{id}".format(**path),
            data=data,
            params=params,
            single_item=True,
        )

    def delete_communication_channel_type(self, address, type, user_id):
        """
        Delete a communication channel.
        ...
        self.logger.debug(
            "DELETE /api/v1/users/{user_id}/communication_channels/{type}/{address} with query params: {params} and form data: {data}".format(
                params=params, data=data, **path
            )
        )
        return self.generic_request(
            "DELETE",
            "/api/v1/users/{user_id}/communication_channels/{type}/{address}".format(
                **path
            ),
            data=data,
            params=params,
    ...
    def delete_push_notification_endpoint(self):
        ...
        self.logger.debug(
            "DELETE /api/v1/users/self/communication_channels/push with query params: {params} and form data: {data}".format(
                params=params, data=data, **path
            )
        )
        return self.generic_request(
            "DELETE",
            "/api/v1/users/self/communication_channels/push".format(**path),
            data=data,
            params=params,
            single_item=True,
        )
...
class Communicationchannel(BaseModel):
    ...
    def address(self, value):
        ...
        self.logger.warn(
            "Setting values on address will NOT update the remote Canvas instance."
        )
        self._address = value
