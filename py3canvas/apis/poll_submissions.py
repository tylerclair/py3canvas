...
class PollSubmissionsAPI(BaseCanvasAPI):
    ...
    def get_single_poll_submission(self, id, poll_id, poll_session_id):
        ...
        self.logger.debug(
            "GET /api/v1/polls/{poll_id}/poll_sessions/{poll_session_id}/poll_submissions/{id} with query params: {params} and form data: {data}".format(
                params=params, data=data, **path
            )
        )
        return self.generic_request(
            "GET",
            "/api/v1/polls/{poll_id}/poll_sessions/{poll_session_id}/poll_submissions/{id}".format(
                **path
            ),
            data=data,
            params=params,
    ...
    def create_single_poll_submission(
        self, poll_id, poll_session_id, poll_submissions_poll_choice_id
    ):
        """
        ...
        self.logger.debug(
            "POST /api/v1/polls/{poll_id}/poll_sessions/{poll_session_id}/poll_submissions with query params: {params} and form data: {data}".format(
                params=params, data=data, **path
            )
        )
        return self.generic_request(
            "POST",
            "/api/v1/polls/{poll_id}/poll_sessions/{poll_session_id}/poll_submissions".format(
                **path
            ),
            data=data,
            params=params,
...
class Pollsubmission(BaseModel):
    ...
    def __init__(
        self, id, poll_choice, poll_choice_id=None, user_id=None, created_at=None
    ):
    ...
    def poll_choice_id(self, value):
        ...
        self.logger.warn(
            "Setting values on poll_choice_id will NOT update the remote Canvas instance."
        )
