...
class TestQuizAssignmentOverridesAPI(unittest.TestCase):
    ...
    def test_retrieve_assignment_overridden_dates_for_classic_quizzes(self):
        ...
        r = self.client.retrieve_assignment_overridden_dates_for_classic_quizzes(course_id, quiz_assignment_overrides_0_quiz_ids=None)
    ...
    def test_retrieve_assignment_overridden_dates_for_new_quizzes(self):
        ...
        r = self.client.retrieve_assignment_overridden_dates_for_new_quizzes(course_id, quiz_assignment_overrides_0_quiz_ids=None)
