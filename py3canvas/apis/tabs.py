...
class TabsAPI(BaseCanvasAPI):
    ...
    def list_available_tabs_for_course_or_group_accounts(self, account_id, include=None):
        """
        ...
        self.logger.debug("GET /api/v1/accounts/{account_id}/tabs with query params: {params} and form data: {data}".format(params=params, data=data, **path))
        return self.generic_request("GET", "/api/v1/accounts/{account_id}/tabs".format(**path), data=data, params=params, no_data=True)
    ...
    def list_available_tabs_for_course_or_group_users(self, user_id, include=None):
        ...
        self.logger.debug("GET /api/v1/users/{user_id}/tabs with query params: {params} and form data: {data}".format(params=params, data=data, **path))
        return self.generic_request("GET", "/api/v1/users/{user_id}/tabs".format(**path), data=data, params=params, no_data=True)
