...
class AuthenticationProvidersAPI(BaseCanvasAPI):
    ...
    def list_authentication_providers(self, account_id):
        ...
        self.logger.debug("GET /api/v1/accounts/{account_id}/authentication_providers with query params: {params} and form data: {data}".format(params=params, data=data, **path))
        return self.generic_request("GET", "/api/v1/accounts/{account_id}/authentication_providers".format(**path), data=data, params=params, all_pages=True)
    ...
    def add_authentication_provider(self, account_id):
        ...
        self.logger.debug("POST /api/v1/accounts/{account_id}/authentication_providers with query params: {params} and form data: {data}".format(params=params, data=data, **path))
        return self.generic_request("POST", "/api/v1/accounts/{account_id}/authentication_providers".format(**path), data=data, params=params, single_item=True)
    ...
    def update_authentication_provider(self, account_id, id):
        ...
        self.logger.debug("PUT /api/v1/accounts/{account_id}/authentication_providers/{id} with query params: {params} and form data: {data}".format(params=params, data=data, **path))
        return self.generic_request("PUT", "/api/v1/accounts/{account_id}/authentication_providers/{id}".format(**path), data=data, params=params, single_item=True)
    ...
    def get_authentication_provider(self, account_id, id):
        ...
        self.logger.debug("GET /api/v1/accounts/{account_id}/authentication_providers/{id} with query params: {params} and form data: {data}".format(params=params, data=data, **path))
        return self.generic_request("GET", "/api/v1/accounts/{account_id}/authentication_providers/{id}".format(**path), data=data, params=params, single_item=True)
    ...
    def delete_authentication_provider(self, account_id, id):
        ...
        self.logger.debug("DELETE /api/v1/accounts/{account_id}/authentication_providers/{id} with query params: {params} and form data: {data}".format(params=params, data=data, **path))
        return self.generic_request("DELETE", "/api/v1/accounts/{account_id}/authentication_providers/{id}".format(**path), data=data, params=params, no_data=True)
    ...
    def show_account_auth_settings(self, account_id):
        ...
        self.logger.debug("GET /api/v1/accounts/{account_id}/sso_settings with query params: {params} and form data: {data}".format(params=params, data=data, **path))
        return self.generic_request("GET", "/api/v1/accounts/{account_id}/sso_settings".format(**path), data=data, params=params, single_item=True)
    ...
    def update_account_auth_settings(self, account_id):
        ...
        self.logger.debug("PUT /api/v1/accounts/{account_id}/sso_settings with query params: {params} and form data: {data}".format(params=params, data=data, **path))
        return self.generic_request("PUT", "/api/v1/accounts/{account_id}/sso_settings".format(**path), data=data, params=params, single_item=True)
...
class Authenticationprovider(BaseModel):
    ...
    def sig_alg(self, value):
        ...
        self.logger.warn("Setting values on sig_alg will NOT update the remote Canvas instance.")
        self._sig_alg = value
    ...
    def jit_provisioning(self, value):
        ...
        self.logger.warn("Setting values on jit_provisioning will NOT update the remote Canvas instance.")
    ...
    def federated_attributes(self, value):
        ...
        self.logger.warn("Setting values on federated_attributes will NOT update the remote Canvas instance.")
    ...
    def mfa_required(self, value):
        ...
        self.logger.warn("Setting values on mfa_required will NOT update the remote Canvas instance.")
...
class Ssosettings(BaseModel):
    ...
    def __init__(self, login_handle_name=None, change_password_url=None, auth_discovery_url=None, unknown_user_url=None):
    ...
    def auth_discovery_url(self, value):
        ...
        self.logger.warn("Setting values on auth_discovery_url will NOT update the remote Canvas instance.")
...
class Federatedattributesconfig(BaseModel):
    ...
    def __init__(self, admin_roles=None, display_name=None, email=None, given_name=None, integration_id=None, locale=None, name=None, sis_user_id=None, sortable_name=None, surname=None, timezone=None):
    ...
    def admin_roles(self, value):
        ...
        self.logger.warn("Setting values on admin_roles will NOT update the remote Canvas instance.")
    ...
    def surname(self, value):
        ...
        self.logger.warn("Setting values on surname will NOT update the remote Canvas instance.")
        self._surname = value
    ...
    def timezone(self, value):
        ...
        self.logger.warn("Setting values on timezone will NOT update the remote Canvas instance.")
...
class Federatedattributeconfig(BaseModel):
    ...
    def attribute(self, value):
        ...
        self.logger.warn("Setting values on attribute will NOT update the remote Canvas instance.")
    ...
    def provisioning_only(self, value):
        ...
        self.logger.warn("Setting values on provisioning_only will NOT update the remote Canvas instance.")
