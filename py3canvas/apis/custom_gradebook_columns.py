...
class CustomGradebookColumnsAPI(BaseCanvasAPI):
    ...
    def create_custom_gradebook_column(self, column_title, course_id, column_hidden=None, column_position=None, column_read_only=None, column_teacher_notes=None):
        """
    ...
    def bulk_update_column_data(self, column_data, course_id):
        ...
        self.logger.debug("PUT /api/v1/courses/{course_id}/custom_gradebook_column_data with query params: {params} and form data: {data}".format(params=params, data=data, **path))
        return self.generic_request("PUT", "/api/v1/courses/{course_id}/custom_gradebook_column_data".format(**path), data=data, params=params, single_item=True)


class Customcolumn(BaseModel):
    """Customcolumn Model."""

    def __init__(self, id=None, teacher_notes=None, title=None, position=None, hidden=None, read_only=None):
    ...
    def teacher_notes(self, value):
        ...
        self.logger.warn("Setting values on teacher_notes will NOT update the remote Canvas instance.")
