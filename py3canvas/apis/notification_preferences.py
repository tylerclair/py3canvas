...
class NotificationPreferencesAPI(BaseCanvasAPI):
    ...
    def list_preferences_communication_channel_id(self, communication_channel_id, user_id):
        """
        List preferences.
    ...
    def list_preferences_type(self, address, type, user_id):
        """
        List preferences.
    ...
    def list_of_preference_categories(self, communication_channel_id, user_id):
        """
        ...
        return self.generic_request("GET", "/api/v1/users/{user_id}/communication_channels/{communication_channel_id}/notification_preference_categories".format(**path), data=data, params=params, no_data=True)

    def get_preference_communication_channel_id(self, communication_channel_id, notification, user_id):
        """
        Get a preference.
    ...
    def get_preference_type(self, address, notification, type, user_id):
        """
        Get a preference.
    ...
    def update_preference_communication_channel_id(self, communication_channel_id, notification, notification_preferences_frequency):
        """
        Update a preference.
    ...
    def update_preference_type(self, address, notification, notification_preferences_frequency, type):
        """
        Update a preference.
    ...
    def update_multiple_preferences_type(self, address, notification_preferences_<X>_frequency, type):
        """
        Update multiple preferences.
...
class Notificationpreference(BaseModel):
    ...
    def __init__(self, href=None, notification=None, category=None, frequency=None):
