...
import requests
import secrets
from py3canvas.apis.plagiarism_detection_platform_users import PlagiarismDetectionPlatformUsersAPI
...
class TestPlagiarismDetectionPlatformUsersAPI(unittest.TestCase):
    ...
    def setUp(self):
        self.client = PlagiarismDetectionPlatformUsersAPI(secrets.instance_address, secrets.access_token)
