...
class CalendarEventsAPI(BaseCanvasAPI):
    ...
    def list_calendar_events(self, all_events=None, context_codes=None, end_date=None, excludes=None, important_dates=None, start_date=None, type=None, undated=None):
        """
    ...
    def list_calendar_events_for_user(self, user_id, all_events=None, context_codes=None, end_date=None, exclude_submission_types=None, excludes=None, important_dates=None, start_date=None, submission_types=None, type=None, undated=None):
        """
    ...
    def update_calendar_event(self, id, calendar_event_all_day=None, calendar_event_child_event_data_X_context_code=None, calendar_event_child_event_data_X_end_at=None, calendar_event_child_event_data_X_start_at=None, calendar_event_context_code=None, calendar_event_description=None, calendar_event_end_at=None, calendar_event_location_address=None, calendar_event_location_name=None, calendar_event_start_at=None, calendar_event_time_zone_edited=None, calendar_event_title=None):
        """
    ...
    def create_or_update_events_directly_for_course_timetable(self, course_id, course_section_id=None, events=None, events_code=None, events_end_at=None, events_location_name=None, events_start_at=None, events_title=None):
        """
...
class Calendarevent(BaseModel):
    ...
    def important_dates(self, value):
        ...
        self.logger.warn("Setting values on important_dates will NOT update the remote Canvas instance.")
...
class Assignmentevent(BaseModel):
    ...
    def __init__(self, id=None, title=None, start_at=None, end_at=None, description=None, context_code=None, workflow_state=None, url=None, html_url=None, all_day_date=None, all_day=None, created_at=None, updated_at=None, assignment=None, assignment_overrides=None, important_dates=None):
