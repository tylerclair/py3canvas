...
class TestMediaObjectsAPI(unittest.TestCase):
    ...
    def test_list_media_tracks_for_media_object(self):
        ...
        r = self.client.list_media_tracks_for_media_object(
            media_object_id, include=None
        )
    ...
    def test_list_media_objects_media_objects(self):
        ...
        r = self.client.list_media_objects_media_objects(
            exclude=None, order=None, sort=None
        )
    ...
    def test_list_media_objects_courses(self):
        ...
        r = self.client.list_media_objects_courses(
            course_id, exclude=None, order=None, sort=None
        )
    ...
    def test_list_media_objects_groups(self):
        ...
        r = self.client.list_media_objects_groups(
            group_id, exclude=None, order=None, sort=None
        )
