...
class TestAssignmentGroupsAPI(unittest.TestCase):
    ...
    def setUp(self):
        self.client = AssignmentGroupsAPI(
    ...
    def test_list_assignment_groups(self):
        ...
        r = self.client.list_assignment_groups(
            course_id,
            assignment_ids=None,
    ...
    def test_get_assignment_group(self):
        ...
        r = self.client.get_assignment_group(
            assignment_group_id,
            course_id,
            grading_period_id=None,
            include=None,
    ...
    def test_destroy_assignment_group(self):
        ...
        r = self.client.destroy_assignment_group(
            assignment_group_id, course_id, move_assignments_to=None
        )
