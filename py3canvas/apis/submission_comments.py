...
class SubmissionCommentsAPI(BaseCanvasAPI):
    ...
    def edit_submission_comment(
        self, assignment_id, course_id, id, user_id, comment=None
    ):
        """
        ...
        self.logger.debug(
            "PUT /api/v1/courses/{course_id}/assignments/{assignment_id}/submissions/{user_id}/comments/{id} with query params: {params} and form data: {data}".format(
                params=params, data=data, **path
            )
        )
        return self.generic_request(
            "PUT",
            "/api/v1/courses/{course_id}/assignments/{assignment_id}/submissions/{user_id}/comments/{id}".format(
                **path
            ),
            data=data,
            params=params,
    ...
    def delete_submission_comment(self, assignment_id, course_id, id, user_id):
        ...
        self.logger.debug(
            "DELETE /api/v1/courses/{course_id}/assignments/{assignment_id}/submissions/{user_id}/comments/{id} with query params: {params} and form data: {data}".format(
                params=params, data=data, **path
            )
        )
        return self.generic_request(
    ...
    def upload_file(self, assignment_id, course_id, user_id):
        ...
        self.logger.debug(
            "POST /api/v1/courses/{course_id}/assignments/{assignment_id}/submissions/{user_id}/comments/files with query params: {params} and form data: {data}".format(
                params=params, data=data, **path
            )
        )
        return self.generic_request(
            "POST",
            "/api/v1/courses/{course_id}/assignments/{assignment_id}/submissions/{user_id}/comments/files".format(
                **path
            ),
            data=data,
            params=params,
