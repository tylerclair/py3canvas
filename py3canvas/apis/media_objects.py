...
class MediaObjectsAPI(BaseCanvasAPI):
    ...
    def list_media_tracks_for_media_object(self, media_object_id, include=None):
        ...
        if include is not None:
            self._validate_enum(include, ["content", "webvtt_content", "updated_at", "created_at"])
            params["include"] = include


        self.logger.debug("GET /api/v1/media_objects/{media_object_id}/media_tracks with query params: {params} and form data: {data}".format(params=params, data=data, **path))
        return self.generic_request("GET", "/api/v1/media_objects/{media_object_id}/media_tracks".format(**path), data=data, params=params, all_pages=True)
    ...
    def update_media_tracks(self, media_object_id, include=None):
        ...
        self.logger.debug("PUT /api/v1/media_objects/{media_object_id}/media_tracks with query params: {params} and form data: {data}".format(params=params, data=data, **path))
        return self.generic_request("PUT", "/api/v1/media_objects/{media_object_id}/media_tracks".format(**path), data=data, params=params, all_pages=True)
    ...
    def list_media_objects_media_objects(self, exclude=None, order=None, sort=None):
        ...
        self.logger.debug("GET /api/v1/media_objects with query params: {params} and form data: {data}".format(params=params, data=data, **path))
        return self.generic_request("GET", "/api/v1/media_objects".format(**path), data=data, params=params, all_pages=True)

    def list_media_objects_courses(self, course_id, exclude=None, order=None, sort=None):
        """
        List Media Objects.
        ...
        self.logger.debug("GET /api/v1/courses/{course_id}/media_objects with query params: {params} and form data: {data}".format(params=params, data=data, **path))
        return self.generic_request("GET", "/api/v1/courses/{course_id}/media_objects".format(**path), data=data, params=params, all_pages=True)
    ...
    def list_media_objects_groups(self, group_id, exclude=None, order=None, sort=None):
        ...
        self.logger.debug("GET /api/v1/groups/{group_id}/media_objects with query params: {params} and form data: {data}".format(params=params, data=data, **path))
        return self.generic_request("GET", "/api/v1/groups/{group_id}/media_objects".format(**path), data=data, params=params, all_pages=True)
    ...
    def update_media_object(self, media_object_id, user_entered_title=None):
        ...
        self.logger.debug("PUT /api/v1/media_objects/{media_object_id} with query params: {params} and form data: {data}".format(params=params, data=data, **path))
        return self.generic_request("PUT", "/api/v1/media_objects/{media_object_id}".format(**path), data=data, params=params, no_data=True)


class Mediatrack(BaseModel):
    """Mediatrack Model."""

    def __init__(self, id=None, user_id=None, media_object_id=None, kind=None, locale=None, content=None, created_at=None, updated_at=None, webvtt_content=None):
    ...
    def media_object_id(self, value):
        ...
        self.logger.warn("Setting values on media_object_id will NOT update the remote Canvas instance.")
    ...
    def kind(self, value):
        ...
        self.logger.warn("Setting values on kind will NOT update the remote Canvas instance.")
        self._kind = value
    ...
    def webvtt_content(self, value):
        ...
        self.logger.warn("Setting values on webvtt_content will NOT update the remote Canvas instance.")
...
class Mediaobject(BaseModel):
    ...
    def __init__(self, can_add_captions=None, user_entered_title=None, title=None, media_id=None, media_type=None, media_tracks=None, media_sources=None):
    ...
    def can_add_captions(self, value):
        ...
        self.logger.warn("Setting values on can_add_captions will NOT update the remote Canvas instance.")
    ...
    def user_entered_title(self, value):
        ...
        self.logger.warn("Setting values on user_entered_title will NOT update the remote Canvas instance.")
    ...
    def media_tracks(self, value):
        ...
        self.logger.warn("Setting values on media_tracks will NOT update the remote Canvas instance.")
    ...
    def media_sources(self, value):
        ...
        self.logger.warn("Setting values on media_sources will NOT update the remote Canvas instance.")
