"""WebhooksSubscriptionsForPlagiarismPlatform API Version 1.0.
...
class WebhooksSubscriptionsForPlagiarismPlatformAPI(BaseCanvasAPI):
    """WebhooksSubscriptionsForPlagiarismPlatform API Version 1.0."""

    def __init__(self, *args, **kwargs):
        """Init method for WebhooksSubscriptionsForPlagiarismPlatformAPI."""
        super(WebhooksSubscriptionsForPlagiarismPlatformAPI, self).__init__(*args, **kwargs)
        self.logger = logging.getLogger("py3canvas.WebhooksSubscriptionsForPlagiarismPlatformAPI")

    def create_webhook_subscription(self, subscription_ContextId, subscription_ContextType, subscription_EventTypes, subscription_Format, subscription_TransportMetadata, subscription_TransportType):
        """
        ...
        # REQUIRED - subscription[ContextId]
        """
            The id of the context for the subscription.
        """
        data["subscription[ContextId]"] = subscription_ContextId
        ...
        return self.generic_request("POST", "/api/lti/subscriptions".format(**path), data=data, params=params, no_data=True)
