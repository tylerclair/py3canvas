...
import requests
import secrets
from py3canvas.apis.quiz_ip_filters import QuizIpFiltersAPI
from py3canvas.apis.quiz_ip_filters import Quizipfilter
...
class TestQuizIpFiltersAPI(unittest.TestCase):
    ...
    def test_get_available_quiz_ip_filters(self):
        ...
        r = self.client.get_available_quiz_ip_filters(course_id, quiz_id)
